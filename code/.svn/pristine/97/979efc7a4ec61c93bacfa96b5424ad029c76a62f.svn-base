			...
			<ul class="page-sidebar-menu">
				...
				<li class=""><a href="javascript:;"> <i class="icon-cogs"></i>
					...
					<ul class="sub-menu">
						...
						<li><a href="${basePath}/circle/list">
				...
				<li class=""><a href="javascript:;"> <i
					...
					<ul class="sub-menu">
						...
						<li><a href="${basePath}/articles">文章</a></li>
				...
				<li class="active ">
					...
					<ul class="sub-menu">
						...
						<li><a href="${basePath}/users"> <i class="icon-time"></i>

								用户管理
						</a></li>

						<li><a href="${basePath}/android/list"> <i
								class="icon-cogs"></i> 版本管理
						</a></li>
						
						<li><a href="${basePath}/soa"> <i
								class="icon-cogs"></i> dubbo服务管理
						</a></li>
				...
				<li class=""><a href="javascript:;"> <i class="icon-bar-chart"></i>

						<span class="title">统计报表</span> <span class="arrow "></span>

				</a>

					<ul class="sub-menu">

						<li><a href="${basePath}/report/user/active"> 活跃用户</a></li>
